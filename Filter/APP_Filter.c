...
{
  set_cutoff_frequency(1000, 80,&Butter_80HZ_Parameter_Acce);
  set_cutoff_frequency(1000, 60,&Butter_60HZ_Parameter_Acce);
  set_cutoff_frequency(1000, 51,&Butter_51HZ_Parameter_Acce);
  set_cutoff_frequency(1000, 30,&Butter_30HZ_Parameter_Acce);
  set_cutoff_frequency(1000, 20,&Butter_20HZ_Parameter_Acce);
  set_cutoff_frequency(1000, 15,&Butter_15HZ_Parameter_Acce);
  set_cutoff_frequency(1000, 10,&Butter_10HZ_Parameter_Acce);
  set_cutoff_frequency(1000, 5 ,&Butter_5HZ_Parameter_Acce);
  set_cutoff_frequency(1000, 2 ,&Butter_2HZ_Parameter_Acce);//速度读取2ms
}
